  ...
  return function n(a, o, u) {
    function s(t, e) {
      ...
      _ = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"];function v(e) {
        ...
        if (!(e = e && e.getAttribute("data-date"))) return null;var t = e.split("-").map(Number);return 3 === t.length && !t.some(Number.isNaN) ? new Date(t[0], t[1] - 1, t[2]) : null;
      }function C(e, t, r) {
        if (!e) return !1;var n = !1,
            a = e.querySelector("table.js-calendar-graph-table, table.ContributionCalendar-grid");if (a) {
          var o = Array.prototype.slice.call(a.querySelectorAll("tbody tr")),
              u = [];o.forEach(function (e) {
            Array.prototype.slice.call(e.querySelectorAll("td.ContributionCalendar-day[data-date]")).forEach(function (e, n) {
              var a = w(e);a && a >= t && (u[n] = !0);
            });
          }), u.length && (o.forEach(function (e) {
            Array.prototype.slice.call(e.querySelectorAll("td.ContributionCalendar-day[data-date]")).forEach(function (e, r) {
              if (!u[r]) {
                var n = e.getAttribute("id"),
                    l = n && a.querySelector('tool-tip[for="' + n + '"]');l && l.parentElement && l.parentElement.removeChild(l), e.parentElement && e.parentElement.removeChild(e);
              } else {
                e.innerHTML || (e.innerHTML = '<span class="calendar-day-glow calendar-day-glow-x"></span><span class="calendar-day-glow calendar-day-glow-y"></span><span class="calendar-day-core"></span>');var s = w(e);s && s < t && (e.style.visibility = "hidden", e.removeAttribute("data-date"), e.removeAttribute("tabindex"));
              }
            });
          }), Array.prototype.slice.call(a.querySelectorAll("thead tr")).forEach(function (e) {
            var t = 0;Array.prototype.slice.call(e.children).slice(1).forEach(function (e) {
              for (var r = parseInt(e.getAttribute("colspan") || "1", 10) || 1, n = 0, a = t; a < t + r; a++) {
                u[a] && n++;
              }t += r, n ? e.setAttribute("colspan", n) : e.parentElement && e.parentElement.removeChild(e);
            });
          }), n = !0);
        }var s = e.querySelector(".js-calendar-graph-svg");if (s) {
          var i = Array.prototype.slice.call(s.querySelectorAll("rect.ContributionCalendar-day[data-date]")),
              c = [];i.forEach(function (e) {
            var r = w(e),
                n = r && r >= t;e.style.display = n ? "" : "none", n && c.push(e);
          }), c.length ? (i = c.map(function (e) {
            for (var t = parseFloat(e.getAttribute("x") || "0") || 0, r = e.parentElement; r && r !== s; r = r.parentElement) {
              var n = (r.getAttribute("transform") || "").match(/translate\(\s*([-.\d]+)(?:[\s,]+[-.\d]+)?\s*\)/);n && (t += parseFloat(n[1]) || 0);
            }return t;
          }), o = Math.max(0, Math.min.apply(Math, i) - 16), u = Math.max.apply(Math, i), i = parseFloat(c[0].getAttribute("width") || "10") || 10, c = Math.ceil(u - o + i + 8), s.setAttribute("width", c), s.setAttribute("viewBox", o + " 0 " + c + " " + (s.getAttribute("height") || 128)), s.style.width = c + "px", s.style.maxWidth = "100%", n = !0) : i.length && (n = !0);
        }return n && e.classList && e.classList.add("calendar-recent-months"), n;
      }function x(e, t) {
        if (!t || !(0 < t)) return !1;var r = new Date();return r.setHours(0, 0, 0, 0), r.setMonth(r.getMonth() - t), C(e, r, t);
